...
时限方面有两点必须严格区分：\textbf{首批截止时间}仅约束"是否首批保障 $=$ 是"的 30 个货箱，且每个服务区恰好 2 箱（医疗 1 $+$ 饮用水 1）；\textbf{期望送达时间}则对全部 80 箱都有约束。如图~\ref{fig:boxes}(f) 所示，首批截止时间呈 60/120/180\,min 三档分布，其中\textbf{8 个服务区的首批截止为 60\,min}（S001、S002、S006、S007、S010、S012、S013、S014），这一高紧迫度需求将在问题二中被证明是本机队规模下的物理瓶颈。
