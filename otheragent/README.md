...
- Q2：14 架次（全 C 型）、77.94 kWh、完工 5.18 h、准时率 55.0%（首批超时 17 箱）；**物理类硬约束违规 0 条**
- Q3：运输 14 架次 + 中继 14 架次、覆盖 14/14 = 100%、总能耗 87.88 kWh（运输 77.94 + 中继 9.94）、联合完工 5.19 h、平均直连中断占比 36.8%
- Q4：2 个连通分量（原子单元）⇒ K=2 零改动可行、K=3 需拆 1 个多点架次；桥接架次 8 个（T007、T002、T003、T004、T009、T011、T013、T014）；K=1/2/3 资源总量 12/16/21，最大组工作量 9.94/9.38/8.93 h
