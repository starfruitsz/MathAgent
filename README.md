...
| **P3 / Q3** 通信约束下运输与中继联合调度 | ✅ 完成 | 20 个中继架次 / **20-20 全程通信覆盖（100%）** / 总能耗 82.14 kWh / 联合完工 3.15 h；无通信类违规 |
...
| **Q3** | 通信约束下运输与中继联合调度 | ★ 实测 **20/25 需保障架次存在直连中断** → **中继为必需项**；链路门限：直连 122 dB / 中继接入 116 dB / 中继回传 126 dB；运输 25 + 中继 20 架次、**20-20 全程覆盖**、总能耗 82.14 kWh、联合完工 3.15 h、平均中断占比 28.4% |
