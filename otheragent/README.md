...
- Q2：35 架次（全 B 型）、83.01 kWh、完工 9.78 h、准时率 38.8%；**物理类硬约束违规 0 条**
- Q3：运输 35 架次 + 中继 30 架次、覆盖 29/29、总能耗 99.68 kWh、联合完工 9.90 h
- Q4：单一连通分量 ⇒ 不存在合法 2/3 组分区；K=1/2/3 资源总量 13/17/21
