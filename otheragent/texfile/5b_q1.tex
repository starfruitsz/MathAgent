...
\begin{equation}
	\label{eq:20}
	\begin{aligned}
		LB_i=\max\Bigg(&\left\lceil\frac{\sum_{b\in\mathcal{B}_i}m_{b}}{\max_{g}q_{max}^{safe}(g,i)}\right\rceil,\\
...
\input{texfile/tab_q1_rho_sweep}
